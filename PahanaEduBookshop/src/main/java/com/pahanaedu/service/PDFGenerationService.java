...
public class PDFGenerationService {
    ...
    public byte[] generateBillPDF(Bill bill) throws IOException {
        ...
        try {
            ...
            // Company Header - Updated for Sri Lanka
            ...
            Paragraph companyAddress = new Paragraph("No. 123, Education Street, Colombo 07, Sri Lanka\nPhone: +94 11 234 5678 | Mobile: +94 77 123 4567 | Email: info@pahanaedu.lk")
                    .setFont(normalFont)
                    .setFontSize(10)
                    .setTextAlignment(TextAlignment.CENTER)
                    .setMarginBottom(20);
            ...
            itemsTable.addHeaderCell(new Cell().add(new Paragraph("Unit Price (LKR)").setFont(headerFont))
                    .setBackgroundColor(ColorConstants.LIGHT_GRAY).setTextAlignment(TextAlignment.RIGHT));
            itemsTable.addHeaderCell(new Cell().add(new Paragraph("Total (LKR)").setFont(headerFont))
                    .setBackgroundColor(ColorConstants.LIGHT_GRAY).setTextAlignment(TextAlignment.RIGHT));
            ...
            if (bill.getBillItems() != null && !bill.getBillItems().isEmpty()) {
                for (BillItem item : bill.getBillItems()) {
                    ...
                    itemsTable.addCell(new Cell().add(new Paragraph(String.valueOf(item.getQuantity())).setFont(normalFont))
                            .setTextAlignment(TextAlignment.CENTER));
                    itemsTable.addCell(new Cell().add(new Paragraph("Rs. " + String.format("%.2f", item.getUnitPrice())).setFont(normalFont))
                            .setTextAlignment(TextAlignment.RIGHT));
                    itemsTable.addCell(new Cell().add(new Paragraph("Rs. " + String.format("%.2f", item.getTotalPrice())).setFont(normalFont))
                            .setTextAlignment(TextAlignment.RIGHT));
                ...
                itemsTable.addCell(new Cell().add(new Paragraph("0").setFont(normalFont))
                        .setTextAlignment(TextAlignment.CENTER));
                itemsTable.addCell(new Cell().add(new Paragraph("Rs. 0.00").setFont(normalFont))
                        .setTextAlignment(TextAlignment.RIGHT));
                itemsTable.addCell(new Cell().add(new Paragraph("Rs. 0.00").setFont(normalFont))
                        .setTextAlignment(TextAlignment.RIGHT));
            }
            ...
            totalTable.addCell(new Cell().add(new Paragraph("Rs. " + String.format("%.2f", subtotal)).setFont(headerFont))
                    .setBorder(null).setTextAlignment(TextAlignment.RIGHT));
            
            totalTable.addCell(new Cell().add(new Paragraph("VAT (0%):").setFont(normalFont))
                    .setBorder(null).setTextAlignment(TextAlignment.RIGHT));
            totalTable.addCell(new Cell().add(new Paragraph("Rs. 0.00").setFont(normalFont))
                    .setBorder(null).setTextAlignment(TextAlignment.RIGHT));
            ...
            totalTable.addCell(new Cell().add(new Paragraph("Rs. " + String.format("%.2f", bill.getTotalAmount())).setFont(titleFont).setFontSize(14))
                    .setBorder(null).setTextAlignment(TextAlignment.RIGHT)
                    .setBackgroundColor(ColorConstants.LIGHT_GRAY).setPadding(5));
            
            document.add(totalTable);
            
            // Footer - Updated for Sri Lanka
            Paragraph footer = new Paragraph("\nThank you for your business!\nFor any queries, please contact us at info@pahanaedu.lk\nRegistered in Sri Lanka")
                    .setFont(normalFont)
                    .setFontSize(9)
                    .setTextAlignment(TextAlignment.CENTER)
                    .setMarginTop(30)
